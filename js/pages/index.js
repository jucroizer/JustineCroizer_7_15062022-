...
function refreshListeIng(majRecipes) {
  console.log("je suis chez les ingrédients", majRecipes);
...
function refreshListeApp(majRecipes) {
  console.log("je suis chez les appareils", majRecipes);
